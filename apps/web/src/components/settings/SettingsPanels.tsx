  ...
  return (
    <>
      ...
      {hasDesktopBridge ? (
        <SettingsRow
          title="Update track"
          description="Receives prerelease builds from the T3 Code Alpha repository. Official Stable and Nightly feeds remain isolated."
          control={<Badge variant="outline">Alpha</Badge>}
        />
      ...
      <SettingsSection id="appearance-interface" title="Interface">
        ...
        {showEnvironmentIdentification ? (
          <SettingsRow
            ...
            description="Choose how Alpha, Dev, and Nightly environments are identified."
            resetAction={
