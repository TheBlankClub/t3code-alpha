...
const alphaMacIconPngPath = NodePath.join(repoRoot, "assets", "alpha", "alpha-macos-1024.png");
...
export function resolveMacLauncherIconPaths(runtimeDir, development = isDevelopment) {
  return {
    sourceIconPath: development ? developmentMacIconPngPath : alphaMacIconPngPath,
    generatedIconPath: NodePath.join(runtimeDir, development ? "icon-dev.icns" : "icon-alpha.icns"),
  };
}
