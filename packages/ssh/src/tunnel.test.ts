...
describe("ssh tunnel scripts", () => {
  it("builds the remote t3 runner with npx and npm fallbacks", () => {
    ...
    assert.include(script, "require_installed_t3_cli npx --yes --package 't3code-alpha@latest'");
    assert.include(
      script,
      "require_installed_t3_cli npm exec --yes --package 't3code-alpha@latest'",
    );
    assert.include(script, "npm produced no t3-alpha executable");
