...
- 2026-09-25, upstream `e5a46d6c5d00b89afba5274a94d42428c8d79763`: `unaffected`. The arm64 DMG, pinned signing certificate, and Homebrew upgrade path are unchanged.
...
- 2026-09-20, upstream `7445aa733ada33e45289e5aa5055f79142556513`: `unaffected`. The incoming changes do not alter cask generation, signing, or upgrade paths.

- 2026-09-19, upstream `dfbb11bdd7c3f1a5575cb55d3e3abb12be025727`: `mechanical-conflict`. Updated the cask generator for the new Effect flag API. The tap, certificate, and arm64 artifact policy remain unchanged.

- 2026-09-18, upstream `03950089ffa5cecf0ce731227f58551f6437495f`: `unaffected`. The Alpha cask, pinned certificate, and arm64 release path remain unchanged.
...
- 2026-09-13, upstream `20363c32c9bfdbf49c2716ef11d1f18483fcc01b`: `unaffected`.
  Upstream did not change the cask or signing policy.
...
- 2026-09-11, upstream `c52b8d96e4b34201f19b5e5bb12c6b2a77bfaa9a`: `unaffected`. No incoming
  change to the release workflow, cask renderer, or Homebrew tap.
...
- 2026-09-07, upstream `f57d3832c0219b4f6fbe2e86f824fedd232492c0`: `unaffected`. The fork certificate, cask generator, and Homebrew upgrade path remain unchanged.

- 2026-09-06, upstream `e5d086c262daab13a8adbb253e281c07ab235533`: `unaffected`. The fork certificate, cask, release destinations, and state-preserving upgrade path remain unchanged.
...
- 2026-09-26, upstream `a21b42cec478b093cdc50cc2105b5368ea8b3546`: `unaffected`. Homebrew upgrade behavior is unchanged.
