...
- 2026-09-21, upstream `1de563c1491c7d82563e4553bf5bf689ce6adbb9`: `unaffected`. Upstream does not change direct-agent ordering in the shared runtime.
...
- 2026-09-20, upstream `7445aa733ada33e45289e5aa5055f79142556513`: `unaffected`. The incoming changes do not alter agent ordering or retention.
...
- 2026-09-15, upstream `5623089aea68ca62811f51321686c259fa4c810f`: `unaffected`. Upstream changes preserve first-seen ordering in the shared agent panel.
...
- 2026-09-11, upstream `c52b8d96e4b34201f19b5e5bb12c6b2a77bfaa9a`: `unaffected`. Incoming right
  panel and command palette work does not alter direct-agent ordering.

- 2026-09-10, upstream `d29c56a5c404cb0f58d3b2ac41762fa0d0ac28d4`: `unaffected`.
  Incoming pull-request, capture, provider, and mobile work does not alter direct-agent ordering or
  row stability.
...
- 2026-09-07, upstream `f57d3832c0219b4f6fbe2e86f824fedd232492c0`: `unaffected`. Direct agents retain newest-first ordering and stable row positions.
...
- 2026-09-26, upstream `a21b42cec478b093cdc50cc2105b5368ea8b3546`: `unaffected`. Direct agents still sort newest first by first observation.
- 2026-09-26, upstream `95030dc674883f0f2a7fd034b32ce742c8cf55d0`: `unaffected`. Settled-thread ordering is separate from direct-agent `firstSeenAt` sorting. Newest-first agent rows stay stable across activity updates.
