...
- 2026-09-24, upstream `b2b43bef73447c483ceae486890cb79f01c369cb`: `unaffected`. Desktop protocol and backend changes retain Alpha app and state identities. Provider credentials use the existing isolated secrets directory.

- 2026-09-21, upstream `1de563c1491c7d82563e4553bf5bf689ce6adbb9`: `unaffected`. Preview recording and device tooling changes preserve Alpha application, protocol, package, and state identities.
...
- 2026-09-18, upstream `03950089ffa5cecf0ce731227f58551f6437495f`: `mechanical-conflict`. Adopted the 0.0.42 package baseline and desktop bundle changes. Alpha app, protocol, state, package, and service identities remain isolated.
...
- 2026-09-12, upstream `e816064945144957b6eb9b268912a98b0555644b`: `unaffected`. Preview keyboard
  routing and web scroll fixes do not change Alpha identity or state paths.
...
- 2026-09-26, upstream `a21b42cec478b093cdc50cc2105b5368ea8b3546`: `unaffected`. Distribution identity files are unchanged.
