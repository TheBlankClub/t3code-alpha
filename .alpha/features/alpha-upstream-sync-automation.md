...
- 2026-09-20, upstream `7445aa733ada33e45289e5aa5055f79142556513`: `unaffected`. The incoming changes do not alter sync workflows, classification, or merge gates.
...
- 2026-09-13, upstream `20363c32c9bfdbf49c2716ef11d1f18483fcc01b`: `unaffected`.
  Upstream did not change sync automation or its policy.
...
- 2026-09-05, upstream `07d2497db89014ccd71aa077fc809aff47e4af91`: `unaffected`; provider
  settings field-reader cleanup does not alter Alpha sync automation.

- 2026-09-05, upstream `e5a87e8b9ca9db21e0291ddbd54438c5fe56b277`: `unaffected`; pull request
  filter deduplication does not alter Alpha sync automation or its gates.

- 2026-09-05, upstream `2fa5ef4c7bf3aafabe98392d25be7eb86847ce8f`: `mechanical-conflict`;
  adopted upstream CI mirror setup while retaining Alpha branch triggers, GitHub-hosted runners,
  semantic classification, finalization, and conflict escalation.
...
- 2026-09-26, upstream `a21b42cec478b093cdc50cc2105b5368ea8b3546`: `unaffected`. Retired sync workflows stay removed.
